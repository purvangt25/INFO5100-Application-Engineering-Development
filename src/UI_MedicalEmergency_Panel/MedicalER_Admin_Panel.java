 ...
 * @author purva
 */
public class MedicalER_Admin_Panel extends javax.swing.JPanel {

    /**
     * Creates new form MedicalER_Admin_Panel
     */
    ...
    public MedicalER_Admin_Panel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Network network, EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Medical Emergency Admin Work Request Management");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(129, 50, 489, -1));
        ...
        add(btnAssign, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, -1, -1));
        ...
        add(btnComplete, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 310, -1, -1));

        tblMedical.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 109, 690, 182));
        ...
        add(viewDetailsBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 310, -1, -1));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, -1, -1));
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            Emergency p = (Emergency) tblMedical.getValueAt(selectedRow, 3);
    ...
    private void viewDetailsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsBtnActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            if (p.getStatus().equals("Pending")) {
                MedicalER_View_Panel ramop = new MedicalER_View_Panel(userProcessContainer, account, organization, enterprise, network, system, p);
                userProcessContainer.add("MedicalER_View_Panel", ramop);
