...
import UI_Reporting_Agency_AdminPanel.ReportingAgency_Scene_ManagementPanel;
 ...
 * @author shash
 */
public class Scene_Location extends javax.swing.JPanel {

    /**
     * Creates new form Scene_Location
     */
    ...
    public Scene_Location(JPanel userProcessContainer) {
        initComponents();
    ...
    private void setLocationBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setLocationBtnActionPerformed
        ...
        try {
            ...
            if (userProcessContainer.getComponent(componentArray.length - 1) instanceof ReportingAgency_Scene_ManagementPanel) {
                ReportingAgency_Scene_ManagementPanel eduRequestPanel = (ReportingAgency_Scene_ManagementPanel) userProcessContainer.getComponent(componentArray.length - 1);
