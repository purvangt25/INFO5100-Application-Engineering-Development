 ...
 * @author nikhil
 */
public class NGO_ViewPanel extends javax.swing.JPanel {

    /**
     * Creates new form NGO_ViewPanel
     */
    ...
    private NGO_ViewRequestPanel ngoViewRequestJPanel;

    public NGO_ViewPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Network network, EcoSystem system, Resource workRequest) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 40, 380, -1));

        jLabel1.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(102, 0, 102));
        jLabel1.setText("Requested Manager:");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 110, -1, -1));

        jLabel4.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(102, 0, 102));
        jLabel4.setText("Request Type:");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 150, -1, 10));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 230, -1, -1));

        jLabel7.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(102, 0, 102));
        jLabel7.setText("Available Number of Units:");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 270, -1, 20));

        reqManagerTextField.setEditable(false);
        add(reqManagerTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 110, 150, -1));

        reqTypeTextField.setEditable(false);
        add(reqTypeTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 150, 150, 20));

        statusTextField.setEditable(false);
        add(statusTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 190, 150, -1));

        reqUnitsTextField.setEditable(false);
        add(reqUnitsTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 230, 150, -1));
        add(availUntsTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 270, 150, -1));
        ...
        add(updateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 300, -1, -1));
        ...
        add(backBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 300, -1, -1));
